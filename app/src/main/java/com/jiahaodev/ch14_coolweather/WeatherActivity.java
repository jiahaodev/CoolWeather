...
public class WeatherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (weatherString != null) {
            ...
            mWeatherCode = weather.basic.weatherId;
            showWeatherInfo(weather);
        } else {
            //无缓存时去服务器查询天气
            mWeatherCode = getIntent().getStringExtra("weather_code");
            //当没有数据的时候，要先将ScrollView进行隐藏，否则空数据的界面看上去会很奇怪
    ...
    public void requestWeather(final String weatherCode) {
        String weatherUrl = "http://guolin.tech/api/weather?cityid=" + weatherCode + "&key=31c6435b0925450288421c667d6e9d5f";
